...
CREATE SEQUENCE s_coverage_id;

CREATE TABLE books(
    id          integer PRIMARY KEY DEFAULT nextval('s_book_id')
  , name        text    NOT NULL UNIQUE
  , words_count bigint  NOT NULL
  );

CREATE TABLE coverage(
    id        bigint PRIMARY KEY DEFAULT nextval('s_coverage_id')
  , book_id   integer NOT NULL -- foreign key later
